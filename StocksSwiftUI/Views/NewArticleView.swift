...
struct NewsArticleView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return NewsArticleView(newsArticles: [NewsArticleViewModel(articles: article)])
//        return NewsArticleView(newsArticles: [NewsArticleViewModel(articles: article)], onDragBegin: { _ in }, onDragEnd: { _ in })
    }
}
